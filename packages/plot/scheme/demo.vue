...
// Scheme module provides PlotScheme objects that can be directly passed to usePlot().operate().
// Each scheme defines: initial entities, render updates, completion conditions, and skeletons.
